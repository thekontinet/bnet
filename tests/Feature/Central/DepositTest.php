...
class DepositTest extends TestCase
{
    ...
    {
        $response = $this->login()->withDomain()->get(route('deposit'));
    ...
    public function test_can_be_redirected_to_payment_link()
    {
        ...
        $response = $this->login()->withDomain()->post(route('payment'), [
            'amount' => '100.00'
        ]);
    ...
    public function test_can_verify_payment()
    {
        ...
        $response = $this->login()->withDomain()->get(route('payment', [
    ...
    public function test_user_can_credited_after_payment_verification(){
        ...
        $this->login()->withDomain()->get(route('payment', [
            'reference' => $payment->reference
        ]));
